...
#define CMD_RECOVERY_NOR (0x4A)
#define CMD_RECOVERY_EXT (0x4B)
#define CMD_RECOVERY_ALL_NOR (0x4C)
#define CMD_RECOVERY_ALL_EXT (0x4D)
...
//    }
    ...
    */
	...
	if (1)
	{
		...
		rcu_read_lock();
		hash_for_each_possible_rcu(recovery_hashtable, rec_map, elem, lba)
		{
			if (rec_map->lba == lba)
			{
				rec_chk = 1;
