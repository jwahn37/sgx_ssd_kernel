...
#define __NR_sgxssd_pm (__X32_SYSCALL_BIT + 333)
#define __NR_open_key (__X32_SYSCALL_BIT + 334)
#define __NR_close_key (__X32_SYSCALL_BIT + 335)
#define __NR_recovery (__X32_SYSCALL_BIT + 336)
