...
out_raw_dir="block_io_ssu_scale_up_raw_${timestamp}"

out_summary_file="block_io_ssu_scale_up_${timestamp}.summary"

out_csv_file="block_io_ssu_scale_up_${timestamp}.csv"

tmp_file="temp_out_ssu_scale_up_${timestamp}.tmp"
