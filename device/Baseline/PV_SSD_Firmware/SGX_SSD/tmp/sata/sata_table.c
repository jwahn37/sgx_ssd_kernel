...
ATR_NO_SECT|ATR_LBA_EXT	| 	CCL_OTHER,			// 0x37	Set Max Address Ext
			...
			ATR_LBA_EXT |	CCL_FTL_D2H,		// 0x4D PV_SSD all recovery command(EXT)
							...
							CCL_UNDEFINED,		// 0x63
							CCL_UNDEFINED,		// 0x64
			ATR_LBA_NOR |	CCL_FTL_H2D,		// 0x65 PV_CREATE
			ATR_LBA_NOR |	CCL_FTL_H2D,		// 0x66 PV_CHANGE	
			ATR_LBA_NOR |	CCL_FTL_H2D,		// 0x67 PV_DELETE
			ATR_LBA_NOR |	CCL_FTL_H2D,		// 0x68 PV_RECOVERY
			ATR_LBA_NOR |	CCL_FTL_H2D,		// 0x69 PV_WRITE (SAME WITH DMA_WRITE) 
							CCL_UNDEFINED,		// 0x6A
							CCL_UNDEFINED,		// 0x6B
							CCL_UNDEFINED,		// 0x6C
							CCL_UNDEFINED,		// 0x6D
