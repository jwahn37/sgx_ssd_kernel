...
void ftl_test(void)
{
    ...
    DS_auth_write(version, sgx_param, sector_count*512, data, mac, (UINT8*)DS_get_filekey(sgx_param.fid));
    ...
    /*
//     fillup_dataspace(); 
   uart_printf("seq  2000000!");
     tc_write_seq(0,  200000, NUM_PSECTORS_64KB);
     uart_printf("rand 2000000!");
