...
// OOB File Metadata
#define OOB_METADATA_ADDR (RECLAIMABILITY_BMP_ADDR + RECLAIMABILITY_BMP_BYTES)
#define OOB_METADATA_BYTES (((NUM_BANKS * PAGES_PER_BLK * sizeof(UINT32) * 5) + DRAM_ECC_UNIT - 1) / DRAM_ECC_UNIT * DRAM_ECC_UNIT)
