...
//from here, code related SGX
#define SGX_ECP256_KEY_SIZE ECC_CURVE
#define SGX_NISTP_ECP256_KEY_SIZE (SGX_ECP256_KEY_SIZE / sizeof(uint32_t))
#define SGX_SHA256_HASH_SIZE SGX_ECP256_KEY_SIZE

//privatek key size : 32bytes
typedef struct _sgx_ec256_private_t
{
    uint8_t r[SGX_ECP256_KEY_SIZE];
} sgx_ec256_private_t;

//public key size : 64bytes
...
void ecdsa_test();
uint8_t sgx_ecdsa_verify(uint8_t *text, sgx_ec256_public_t p_publicKey, sgx_ec256_signature_t p_signature, sgx_ec256_private_t p_privateKey);
#ifdef __cplusplus
} /* end of extern "C" */
#endif
