...
+ BAD_BLK_BMP_BYTES + PAGE_MAP_BYTES + VCOUNT_BYTES + FLUSH_MAP_BYTES)  //flush
...
#define BYTES_PER_MAP_ENTRY 4 //vpn 4bytes
#define MAP_ENTRY_PER_PAGE BYTES_PER_PAGE / BYTES_PER_MAP_ENTRY   //64*128개
