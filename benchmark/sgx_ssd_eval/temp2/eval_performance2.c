...
#define TOTAL_WORKLOAD_SIZE 1000
#define OPEN_KEY 333
...
int main(int argc, char **argv)
{
	...
	int num_total_files = 50 * 5 * 1024 / 8; // 20MB * 50 files = 1GB
	...
	printf("Write %dMB file with no RT and %dMB files with RT\n\n\n", TOTAL_WORKLOAD_SIZE - TOTAL_WORKLOAD_SIZE * ret_ratio / 100, TOTAL_WORKLOAD_SIZE * num_capacity_files / num_total_files);
