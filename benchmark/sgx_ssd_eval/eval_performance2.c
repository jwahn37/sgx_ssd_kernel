...
int main(int argc, char **argv)
{
	...
	int num_total_files = 50; // 20MB * 50 files = 1GB
	int num_capacity_files = capacity * 50 / 100;
	int num_init_invalid_files = 50 - num_capacity_files; 
	...
	for (i=0; i < num_total_files; i++)
	{
		...
		if(i < num_init_invalid_files)
		{
			...
			//policy notifier call and receive pid!
